  ...
  return (
    <div className="max-w-[1100px] mx-auto px-10 py-9">
      ...
      <div className="mb-9">
        ...
        <h1 className="font-heading text-[28px] font-extrabold text-text">
          Minhas Palestras
        </h1>
        <p className="text-[14px] text-text3 mt-1.5">
      ...
      {lectures.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4.5 stagger-children">
